...
accelerate launch --main_process_port 29501 scripts/train_wm.py --dataset_root_path /n/fs/iromdata/world_model_data/play/auto --dataset_names v0_1208-2200 --config droid_irom_finetune_continue --tag "1215-v0-robotplay-continue"
