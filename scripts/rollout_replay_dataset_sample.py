#!/usr/bin/env python3
"""
Rollout script that randomly samples interactions from trajectories in a dataset.
Unlike rollout_replay_dataset.py which processes entire trajectories sequentially,
this script randomly samples x non-overlapping interactions per trajectory and
saves GT and prediction separately by view.
"""
