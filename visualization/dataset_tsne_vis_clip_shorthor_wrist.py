...
def load_wrist_videos_with_clip_samples(dataset_path, model, processor, num_samples=3,
    ...
    for split in ["train", "val"]:
        ...
        for traj_dir in tqdm(traj_dirs, desc=f"Processing {split} wrist videos"):
...
def main():
    ...
    try:
        ...
        output_file = output_dir / f'{output_prefix}_tsne_clip_shorthor_wrist{suffix}.png'
        plot_tsne(
            features,
            labels,
