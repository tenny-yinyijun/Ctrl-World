...
CKPT_PATH="/n/fs/tom-project/video_models/Ctrl-World/model_ckpt/droid_irom_textcondtrue/checkpoint-8000.pt"
...
# The config uses: /n/fs/iromdata/video_model_training/lab/1120_test_new
