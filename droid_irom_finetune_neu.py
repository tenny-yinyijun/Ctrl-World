...
class wm_args:
    ...
    ########################### training args ##############################
    # model paths
    svd_model_path = "/n/fs/iromdata/video_models/Ctrl-World/clip-vit-base-patch32"
    clip_model_path = "/n/fs/iromdata/video_models/Ctrl-World/stable-video-diffusion-img2vid"
    ckpt_path = "/n/fs/iromdata/video_models/Ctrl-World/checkpoints/checkpoint-10000.pt"
